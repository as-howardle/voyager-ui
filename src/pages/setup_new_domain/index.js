...
const steps = ["Create new records for domain", "Add domain to postfix server", "Add domain to MailerQ", "Add new domain to list definition"];
        ...
        {activeStep === steps.length ? (
          ...
          <React.Fragment>
            ...
            <Box sx={{ display: "flex", justifyContent: "center" }}>
              ...
              {activeStep === 3 && <AddNewDomainToListDefinition next={handleNext} back={handleBack} />}
            </Box>
            {/* <Box sx={{ display: "flex", flexDirection: "row", pt: 2 }}>
